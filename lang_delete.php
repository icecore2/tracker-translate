...
'delete_dusers' => "Delete Users",
'delete_sorry' => "Sorry ",
'delete_nosysop' => "Your not a SysOp !",
'delete_error' => "Error ",
'delete_correct' => "Please fill out the form correctly.",
'delete_verify' => "Bad user name or Id. Please verify that all entered information is correct.",
...
'delete_redirected' => "You'll be automatically redirected to home page in 5 seconds.",
'delete_dacct' => "Delete account",
